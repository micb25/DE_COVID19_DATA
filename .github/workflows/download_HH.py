...
VERBOSE  = True
DATAPATH = os.path.dirname(os.path.abspath(__file__)) + os.sep + ".." + os.sep + ".." + os.sep + "data_HH" + os.sep
DATE_STR = datetime.fromtimestamp(datetime.now().timestamp()).strftime('%Y-%m-%d')
FILENAME = "HH_{}.html".format(DATE_STR)
FULLNAME = DATAPATH + FILENAME
CSV_URL  = "https://www.hamburg.de/corona-zahlen/"
